...
void display() {
	// clear the screen by filling in black
	...
	// draw the triangles loaded into the GPU buffer
...
/*
  Loads the shader program from external vertex and fragment
  files. Extracts variables from the shader program into the C++ code.
 */
void loadShader() {
